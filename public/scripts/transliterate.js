/* Copyright 2007-2019 TRANSLIT.CC. All rights reserved. All materials and code are protected by international copyright law. */
window.t={
txt:document.getElementById("translation"),
mAuto:true,
mBil:false,
mPril:true,
mLng1:"en",
...
mSets:[
  [
    'Universal',
    'Our own compilation',
    '<div><a href="javascript:t.n(2)">α</a></div><div>a</div><div><a href="javascript:t.n(14)">η</a></div><div>h</div><div><a href="javascript:t.n(26)">ν</a></div><div>n</div><div><a href="javascript:t.n(38)">τ</a></div><div>t</div><div><a href="javascript:t.n(4)">β</a></div><div><strong>b</strong>,v</div><div><a href="javascript:t.n(16)">θ</a></div><div class="sm2"><strong>th</strong>,<br/>u</div><div><a href="javascript:t.n(28)">ξ</a></div><div>x</div><div><a href="javascript:t.n(40)">υ</a></div><div>y</div><div><a href="javascript:t.n(6)">γ</a></div><div>g</div><div><a href="javascript:t.n(18)">ι</a></div><div>i</div><div><a href="javascript:t.n(30)">ο</a></div><div>o</div><div><a href="javascript:t.n(42)">φ</a></div><div>f</div><div><a href="javascript:t.n(8)">δ</a></div><div>d</div><div><a href="javascript:t.n(20)">κ</a></div><div>k</div><div><a href="javascript:t.n(32)">π</a></div><div>p</div><div><a href="javascript:t.n(44)">χ</a></div><div>ch</div><div><a href="javascript:t.n(10)">ε</a></div><div>e</div><div><a href="javascript:t.n(22)">λ</a></div><div>l</div><div><a href="javascript:t.n(34)">ρ</a></div><div>r</div><div><a href="javascript:t.n(46)">ψ</a></div><div>ps</div><div><a href="javascript:t.n(12)">ζ</a></div><div>z</div><div><a href="javascript:t.n(24)">μ</a></div><div>m</div><div><a href="javascript:t.n(36)">σ</a></div><div>s</div><div><a href="javascript:t.n(48)">ω</a></div><div>w</div>',
    {A:"Α",a:"α",V:"Β",v:"β",G:"Γ",g:"γ",D:"Δ",d:"δ",E:"Ε",e:"ε",Z:"Ζ",z:"ζ",H:"Η",h:"η","TH":"Θ","Th":"Θ",th:"θ",U:"Θ",u:"θ",I:"Ι",i:"ι",K:"Κ",k:"κ",L:"Λ",l:"λ",M:"Μ",m:"μ",N:"Ν",n:"ν",X:"Ξ",x:"ξ",O:"Ο",o:"ο",P:"Π",p:"π",R:"Ρ",r:"ρ",S:"Σ",s:"σ",T:"Τ",t:"τ",Y:"Υ",y:"υ",F:"Φ",f:"φ","CH":"Χ","Ch":"Χ","ch":"χ","PS":"Ψ","Ps":"Ψ","ps":"ψ",W:"Ω",w:"ω"},
    {Α:"A",α:"a",Β:"V",β:"v",Γ:"G",γ:"g",Δ:"D",δ:"d",Ε:"E",ε:"e",Ζ:"Z",ζ:"z",Η:"I",η:"i",Θ:"Th",θ:"th",Ι:"I",ι:"i",Κ:"K",κ:"k",Λ:"L",λ:"l",Μ:"M",μ:"m",Ν:"N",ν:"n",Ξ:"X",ξ:"x",Ο:"O",ο:"o",Π:"p",π:"p",Ρ:"R",ρ:"r",Σ:"S",σ:"s",Τ:"T",τ:"t",Υ:"Y",υ:"v",Φ:"F",φ:"f",Χ:"Ch",χ:"ch",Ψ:"Ps",ψ:"ps",Ω:"w",ω:"o",ς:"s", ά: "á", ή: "í", ί: "í", ό: "ó", ύ: "v́", ώ: "ó", έ: "é"}
  ]
],
tlng:function(){
t.mPril=!t.mPril;
...
ldc:function(){document.write('<img src="meow.png" width="0" height="0" border="0" alt="" />')},
...
var txt = document.getElementById("txt");
if(advlist.selectedIndex==1){var spl=new spellChecker(txt);urchinTracker("/spellcheck");spl.openChecker();advlist.selectedIndex=0;return;}
var query,big=false;
if (txt.selectionStart>=0) {
